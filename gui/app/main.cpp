...
int main(int, char **) {
  ...
  GLFWwindow *window =
      glfwCreateWindow(1280, 720, "ESP_good_therm", nullptr, nullptr);
  if (window == nullptr)
    return 1;
  ...
  io.ConfigFlags |=
      ImGuiConfigFlags_ViewportsEnable; // Enable Multi-Viewport / Platform
                                        // Windows io.ConfigViewportsNoAutoMerge
                                        // = true;
  ...
  bool ret = LoadTextureFromFile("small_logo.png", &my_image_texture,
...
#endif
  {
    ...
    if (ImGui::BeginMainMenuBar()) {
      ...
      if (ImGui::BeginMenu("Online mode")) {
        ...
        ImGui::SeparatorText(
            std::string("Current device: " + device_name).data());
      ...
      if (ImGui::CollapsingHeader("Shoes")) {
        if (ImGui::TreeNode("Sneakers")) {
          ...
          if (ImGui::BeginTable("Sneakers", 5, flags)) {
            ImGui::TableSetupColumn("Manufacture",
            ...
            ImGui::TableSetupColumn("Stock balance",
    ...
    //     bools storing our window open/close state ImGui::Checkbox("Another
    //     Window", &show_another_window);
    ...
    if (my_tool_active) {
      ...
      // ImGui::SameLine();
      // ImGui::Checkbox("Show ADC_CH4", &show_adc_ch_4);ImGui::Begin("OpenGL
      // Texture Text");
      ...
      if (show_adc_ch_1) {
        ...
        ImGui::PlotLines("ADC_CH1 Graph", samples.data(), 200, 0, "FFFGGG", -10,
                         10, {500, 200});
      }
    ...
    // ImGui::Image((void *)(intptr_t)my_image_texture, ImVec2(50
    // /*my_image_width*/, 50 /*my_image_height*/)); ImGui::End(); auto
    // MAIN_WINDOW = ImGuiWindowFlags_NoMove
